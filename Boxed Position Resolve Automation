...
Automated Double-Entry Unboxing Pair Generation:
...
Multi-Asset Class Routing (Equity vs. Equity Swap):
...
Data Sanitation & String Normalization:
...
Attribute VB_Name = "mod_GTL_Unboxing_Automation" Option Explicit

' ============================================================================== ' Module Name: mod_GTL_Unboxing_Automation ' Purpose: Generates double-entry GTL (Generic Trade Loader) CSV files ' to resolve high-volume Boxed Positions caused by Buy/Short ' and Cover/Sell mismatches across Equity & Swap instruments. ' Author: Ting Huang ' ==============================================================================

Sub GenerateGTL_Generic() Dim wsSource As Worksheet Dim wsOutput As Worksheet Dim lastRow As Long Dim outputRow As Long Dim randomChars As String Dim todayDate As String Dim i As Long Dim baseIdentifier As String
...
Sub FillGTLSheetforEquity() Dim wsResults As Worksheet Dim wsGTL As Worksheet Dim lastRow As Long Dim i As Long, j As Long, k As Long Dim GTLPath As String Dim tempWB As Workbook Dim currentTime As String Dim randomChars As String
...
Sub FillGTLSheetForSwap() Dim wsResults As Worksheet Dim wsGTL As Worksheet Dim lastRow As Long Dim i As Long, j As Long, k As Long Dim GTLPath As String Dim tempWB As Workbook Dim currentTime As String Dim randomChars As String
...
' Helper Function: Pseudo-Random Alpha-Numeric String Generator Private Function GenerateRandomChars(Length As Integer) As String Dim chars As String Dim result As String Dim i As Integer
